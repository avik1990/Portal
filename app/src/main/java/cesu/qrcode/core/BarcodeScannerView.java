...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    @ColorInt private int mLaserColor = getResources().getColor(R.color.scanviewfinder_laser);
    @ColorInt private int mBorderColor = getResources().getColor(R.color.scanviewfinder_border);
    private int mMaskColor = getResources().getColor(R.color.scanviewfinder_mask);
    private int mBorderWidth = getResources().getInteger(R.integer.scanviewfinder_border_width);
    private int mBorderLength = getResources().getInteger(R.integer.scanviewfinder_border_length);
