...
import cesu.qrcode.zxing.Dimension;
import cesu.qrcode.zxing.EncodeHintType;
import cesu.qrcode.zxing.Writer;
import cesu.qrcode.zxing.common.BitMatrix;
import cesu.qrcode.zxing.datamatrix.encoder.DefaultPlacement;
import cesu.qrcode.zxing.datamatrix.encoder.ErrorCorrection;
import cesu.qrcode.zxing.datamatrix.encoder.HighLevelEncoder;
import cesu.qrcode.zxing.datamatrix.encoder.SymbolInfo;
import cesu.qrcode.zxing.datamatrix.encoder.SymbolShapeHint;
import cesu.qrcode.zxing.qrcode.encoder.ByteMatrix;
