...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultLaserColor = getResources().getColor(R.color.scanviewfinder_laser);
    private final int mDefaultMaskColor = getResources().getColor(R.color.scanviewfinder_mask);
    private final int mDefaultBorderColor = getResources().getColor(R.color.scanviewfinder_border);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(R.integer.scanviewfinder_border_width);
    private final int mDefaultBorderLineLength = getResources().getInteger(R.integer.scanviewfinder_border_length);
