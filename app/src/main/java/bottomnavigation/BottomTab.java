...
import static bottomnavigation.BottomTabAnimator.animateTranslationY;
...
class BottomTab {
    ...
    BottomTab(@NonNull BottomBarItem item, @NonNull View root, @ColorInt int activeColor, @ColorInt int inactiveColor) {
        this.item = item;
        this.root = root;
